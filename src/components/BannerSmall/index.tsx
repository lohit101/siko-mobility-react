...
const Banner: React.FC = () => {
    return (
        <div className="w-full flex items-center justify-center">
            <div className="bg-blue-500 w-full mx-5 sm:mx-0 sm:w-4/5 flex flex-col-reverse pt-0 sm:flex-row items-center justify-center py-10 my-20 px-10 sm:px-20 gap-3 rounded-3xl bg-[url('./BannerSmallBg.png')] bg-no-repeat bg-cover">
                ...
                <div className="flex items-center justify-center h-full w-full sm:w-[30%] aspect-square my-3 bg-[url('./BannerSmallRight.png')] bg-no-repeat bg-cover">
