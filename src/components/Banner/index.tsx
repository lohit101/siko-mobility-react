...
const Banner: React.FC = () => {
    return (
        <div className="bg-blue-500 flex flex-row items-center justify-center my-20 px-20 bg-[url('./earth.png')] bg-no-repeat bg-cover">
            <div className="w-1/2 flex flex-col gap-5 my-20">
                ...
                <div className="flex flex-row gap-5">
                    <a href="#" className="bg-white text-blue-500 py-2 px-5 rounded-full">Join as Partner</a>
                    <a href="#" className="text-white py-2 px-5 border-2 border-white rounded-full">Know more</a>
                </div>
            </div>
            <div className="w-1/4">
