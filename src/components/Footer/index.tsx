...
const Footer: React.FC = () => {
    return (
        <footer className='w-full flex items-center justify-center'>
            <div className="bottom-0 left-0 flex flex-col w-full sm:w-4/5 gap-8 px-8 py-16 md:gap-12">
                <div className="flex flex-col sm:flex-row">
                    ...
                    <div className='grid grid-cols-2 gap-8 2xsm:grid-cols-2 md:grid-cols-3 w-full sm:w-2/3 ml-0 mt-10 sm:mt-0 sm:ml-10'>
