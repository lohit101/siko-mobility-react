...
const Services: React.FC<Props> = ({heading, subheading, image}) => {
    return (
        <div className="flex flex-col items-center justify-center py-10 px-10 bg-gradient-to-b from-white to-[#F1F6FF]">
            <p className="m-10 text-5xl font-bold">Our Services For All Mobility</p>
